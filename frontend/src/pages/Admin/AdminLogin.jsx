            ...
            <div className="relative z-10 bg-white p-10 rounded-3xl shadow-2xl w-full max-w-md mx-4 border border-gray-200">
                <div className="flex flex-col items-center mb-8">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-3xl font-bold text-[#1E5144] tracking-tight italic">
                            {t('admin.loginPortal')}
                        </span>
                    </div>
                </div>

                <h2 className="text-xl font-semibold text-gray-700 text-center mb-8">{t('admin.loginTitle')}</h2>
