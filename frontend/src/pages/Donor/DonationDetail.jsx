...
const DonationDetail = () => {
    ...
    const foodName = donation.food_type?.split(' - ')[0] || t('donor.donationDetail.foodDonation');
            ...
            <main className={`flex-1 ml-0 transition-all duration-300 ${isCollapsed ? 'md:ml-16' : 'md:ml-64'} bg-white min-h-screen`}>
                ...
                <div className="p-4 md:p-6 max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        {t('donor.donationDetail.backToHistory')}
                    </button>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        <div className="lg:col-span-8 space-y-8">
                            ...
                            <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100">
                                        ...
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            {donation.is_recurring && (
                                                <span className="px-3 py-1 bg-blue-50 text-blue-500 text-[10px] font-black uppercase tracking-widest rounded-full flex items-center gap-1 border border-blue-100">
                                                    <Repeat size={12} />
                                                    {t('donor.donationDetail.recurring')}
                                                </span>
                                            )}
                                        </div>
                                ...
                                <div className="bg-gray-50/50 rounded-3xl p-6 mb-8 border border-gray-100">
                                    <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-5">{t('donor.donationDetail.packageContents')}</h3>
                                            ...
                                            <div key={idx} className="flex items-center gap-3 p-3 bg-white rounded-2xl border border-gray-50 shadow-sm">
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <p className="text-sm font-bold text-gray-900">{item.name || t('donor.donationDetail.item')}</p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-2">
                                    {!donation.is_recurring && addressDisplay && addressDisplay !== 'Address not set' && (
                                        <div className="flex items-start gap-4">
                                            <div className="p-2.5 bg-blue-50 rounded-xl border border-blue-100">
                                                <MapPin size={20} className="text-blue-500" />
                                            </div>
                                            <div>
                                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">{t('donor.donationDetail.pickupLocation')}</p>
                                    ...
                                    {!donation.is_recurring && pickupTimes && (
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">{t('donor.donationDetail.availableHours')}</p>
                                    ...
                                    {donation.expiry_time && (
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">{t('donor.donationDetail.bestBefore')}</p>
                                    ...
                                    {donation.is_recurring && (
                                        <>
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">{t('donor.donationDetail.frequency')}</p>
                                                    <p className="text-sm font-bold text-gray-800">{translateFrequency(donation.frequency || 'Weekly', t)}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">{t('donor.donationDetail.schedule')}</p>
                                                    <p className="text-sm font-bold text-gray-800">{t('donor.donationDetail.scheduleDay', { day: translateDay(donation.day || 'Monday', t) })}</p>
                                                </div>
                                            </div>
                                        </>
                                    )}
                        ...
                        <div className="lg:col-span-4 space-y-8">
                            <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 text-center">
                                <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-6">{t('donor.donationDetail.currentStatus')}</h3>
                                <div className={`inline-block px-8 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-sm ${statusColors[displayStatus] || 'bg-gray-100 text-gray-700'}`}>
                                    {translateStatus(displayStatus || 'Available', t)}
                                </div>
                                <div className="mt-8 pt-8 border-t border-gray-50">
                                    <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">{t('donor.donationDetail.postedOn')}</h3>
                            ...
                            <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 space-y-4">
                                ...
                                >
                                    <Edit2 size={18} />
                                    {t('donor.donationDetail.editDetails')}
                                </button>
                                ...
                                >
                                    <Trash2 size={18} />
                                    {t('donor.donationDetail.removePost')}
                                </button>
                            </div>
                        </div>
                    </div>
