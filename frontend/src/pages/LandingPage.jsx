    ...
    return (
        <div className="font-sans bg-white text-gray-800">
            ...
            <div className="pt-10 pb-20 bg-white text-center">
                <h2 className="text-3xl font-bold mb-16">{t('landing.howItWorksTitle')}</h2>
                <div className="max-w-4xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-5">
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold mb-2">{t('landing.step1Title')}</h3>
                        <p className="text-gray-600 max-w-xs">{t('landing.step1Desc')}</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold mb-2">{t('landing.step2Title')}</h3>
                        <p className="text-gray-600 max-w-xs">{t('landing.step2Desc')}</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold mb-2">{t('landing.step3Title')}</h3>
