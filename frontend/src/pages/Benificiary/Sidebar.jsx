...
const Sidebar = ({ isOpen, setIsOpen, isCollapsed, setIsCollapsed }) => {
    ...
    const menuItems = [
        { id: 'dashboard', labelKey: 'sidebar.dashboard', icon: <Timer size={22} />, path: '/beneficiary/dashboard' },
        { id: 'profile', labelKey: 'sidebar.profile', icon: <User size={22} />, path: '/beneficiary/profile' },
        { id: 'claim', labelKey: 'sidebar.beneficiary.findFood', icon: <Search size={22} />, path: '/beneficiary/claim' },
        { id: 'myclaims', labelKey: 'sidebar.beneficiary.myClaims', icon: <List size={22} />, path: '/beneficiary/history' },
        { id: 'request', labelKey: 'sidebar.beneficiary.requestFood', icon: <PlusCircle size={22} />, path: '/beneficiary/request' },
        { id: 'myrequests', labelKey: 'sidebar.beneficiary.myRequests', icon: <FileText size={22} />, path: '/beneficiary/my-requests' },
        { id: 'feedback', labelKey: 'sidebar.beneficiary.feedback', icon: <MessageSquare size={22} />, path: '/beneficiary/feedback' },
    ];
